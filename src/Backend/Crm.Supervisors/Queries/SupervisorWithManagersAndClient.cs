...
{
    internal record SupervisorWithManagersAndClientQuery(
        Guid SupervisorId,
        Guid FromManagerId,
        Guid ToManagerId,
        Guid ClientId) : ISingleQuery<Supervisor>;

    internal class SupervisorWithManagersAndClientHandler : ISingleQueryHandler<SupervisorWithManagersAndClientQuery, Supervisor>
    {
