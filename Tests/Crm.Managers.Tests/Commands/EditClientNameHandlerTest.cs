...
namespace Tests.Commands.Managers.Commands
{
    public class EditClientNameHandlerTest
    {
        ...
        private readonly ExceptionHandlerBehavior<EditClientNameRequest> _exceptionHandler;
        ...
        public async Task HandleSuccessfulTest()
        {
            ...
            var request = new EditClientNameRequest(manager.Id, client.Id, name);
        ...
        public async Task HandleIfManagerNotFound()
        {
            ...
            var request = new EditClientNameRequest(Guid.NewGuid(), client.Id, "New name");
        ...
        public async Task HandleIfClientNotFound()
        {
            // Arrange
            (Manager manager, Client client) = Setup();
            var request = new EditClientNameRequest(manager.Id, Guid.NewGuid(), "New name");
        ...
        public async Task HandleIfInvalidRequest()
        {
            // Arrange
            (Manager manager, Client client) = Setup();
            var request = new EditClientNameRequest(manager.Id, client.Id, "");
        ...
        public async Task HandleIfRepositoryThrowsException()
        {
            // Arrange
            (Manager manager, Client client) = Setup();
            var request = new EditClientNameRequest(manager.Id, client.Id, "New name");
