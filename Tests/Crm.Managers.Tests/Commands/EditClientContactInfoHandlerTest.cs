...
namespace Tests.Commands.Managers.Commands
{
    public class EditClientContactInfoHandlerTest
    {
        ...
        private readonly ExceptionHandlerBehavior<EditClientContactInfoRequest> _exceptionHandler;
        ...
        public async Task HandleSuccessfulTest()
        {
            ...
            var request = new EditClientContactInfoRequest(manager.Id, client.Id, newContactInfo.Email, newContactInfo.PhoneNumber);
        ...
        public async Task HandleIfManagerNotFound()
        {
            ...
            var request = new EditClientContactInfoRequest(Guid.NewGuid(), client.Id, "email@mail.com", "+71112223344");
        ...
        public async Task HandleIfClientNotFound()
        {
            // Arrange
            (Manager manager, Client client) = Setup();
            var request = new EditClientContactInfoRequest(manager.Id, Guid.NewGuid(), "email@mail.com", "+71112223344");
        ...
        public async Task HandleIfInvalidRequest()
        {
            // Arrange
            (Manager manager, Client client) = Setup();
            var request = new EditClientContactInfoRequest(manager.Id, client.Id, "", "");
